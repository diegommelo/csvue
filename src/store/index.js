...
export default new Vuex.Store({
  state: {
    players: players,
    team:[
      {name: 'Player #1', pic:'avatar.jpeg', price: 0, picked: false},
      {name: 'Player #2', pic:'avatar.jpeg', price: 0, picked: false},
      {name: 'Player #3', pic:'avatar.jpeg', price: 0, picked: false},
      {name: 'Player #4', pic:'avatar.jpeg', price: 0, picked: false},
      {name: 'Player #5', pic:'avatar.jpeg', price: 0, picked: false},
    ],
    // team: [],
    balance: 15,
    pick: 0,
  ...
  mutations: {
    ...
    sellPlayer(state, pick) {
      if ( state.team[pick].price > 0 && state.balance>=0){
        ...
        state.team[pick].pic = 'avatar.jpeg'
    ...
    reset(state) {
      state.balance = 15
      state.team = [
        {name: 'Player #1', pic:'avatar.jpeg', price: 0},
        {name: 'Player #2', pic:'avatar.jpeg', price: 0},
        {name: 'Player #3', pic:'avatar.jpeg', price: 0},
        {name: 'Player #4', pic:'avatar.jpeg', price: 0},
        {name: 'Player #5', pic:'avatar.jpeg', price: 0},                                        
      ]
      state.pick = 0
    }
  },
